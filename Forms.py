...
class PredictionForm(Form):
    ...
    town = SelectField('Town:', [validators.DataRequired()], choices=[('SENGKANG', 'SENGKANG'),('WOODLANDS', 'WOODLANDS'),('PUNGGOL', 'PUNGGOL'), ('TAMPINES', 'TAMPINES'), ('JURONG WEST', 'JURONG WEST'),('YISHUN', 'YISHUN'),('BEDOK', 'BEDOK'),('HOUGANG', 'HOUGANG'),('CHOA CHU KANG', 'CHOA CHU KANG'),('ANG MO KIO', 'ANG MO KIO'),('BUKIT MERAH', 'BUKIT MERAH'),('BUKIT PANJANG', 'BUKIT PANJANG'),('BUKIT BATOK', 'BUKIT BATOK'),('TOA PAYOH', 'TOA PAYOH'),('PASIR RIS', 'PASIR RIS'),('KALLANG/WHAMPOA', 'KALLANG/WHAMPOA'),('QUEENSTOWN', 'QUEENSTOWN'),('SEMBAWANG', 'SEMBAWANG'),
                                                                      ('GEYLANG', 'GEYLANG'),('CLEMENTI', 'CLEMENTI'),('JURONG EAST', 'JURONG EAST'),('SERANGOON', 'SERANGOON'),('BISHAN', 'BISHAN'),('CENTRAL AREA', 'CENTRAL AREA'),('MARINE PARADE', 'MARINE PARADE'),('BUKIT TIMAH', 'BUKIT TIMAH')], default='01 TO 03')
